...
//            @Override
//            public void run() {
//            OldGertecPrinter.printer = new wangpos.sdk4.libbasebinder.Printer(mContext);
//            }
//        }.start();
//    }
//
...
//
//            printer.printText("", 36, "CENTER", "NORMAL");
//            printer.printBarCode(seed);
//            Thread.sleep(800);
...
//                printer.printText(s, fontSize, textAlign, fontWeight);
//
//            transactionMessenger.customLoadUrl("javascript:onReturnValue('', 0)");
//        } catch (Exception e) {
...
//                printer.printText(s, 16, "CENTER", "NORMAL");
//
//            printer.printText("\n", 72);
//
//            transactionMessenger.customLoadUrl("javascript:onReturnValue('', 0)");
