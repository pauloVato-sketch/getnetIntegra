...
public class CordovaInterfaceImpl implements CordovaInterface {
    ...
    protected CordovaActivity activity;
    ...
    public CordovaInterfaceImpl(CordovaActivity activity) {
        this(activity, Executors.newCachedThreadPool());
    }

    public CordovaInterfaceImpl(CordovaActivity activity, ExecutorService threadPool) {
