...
import com.odhen.stoneintegration.printer.PrintCallback;
import com.odhen.stoneintegration.printer.Printer;
import com.odhen.stoneintegration.printer.StonePrinter;
...
public class StoneIntegration implements PosIntegration, StoneActionCallback, PrintCallback {
    ...
    public void init(String stoneCode, String environment, Context context, final TransactionMessenger transactionMessenger) {
