...
import com.odhen.stoneintegration.Util;
...
public class StonePrinter implements Printer {
    ...
    public void printCoupon(TransactionObject transactionObject, ReceiptType receiptType, final PrintCallback printCallback) {
        final PosPrintReceiptProvider posPrintReceiptProvider = new PosPrintReceiptProvider(context, transactionObject, receiptType);
    ...
    @Override
    public void printImage(String base64, final PrintCallback printCallback) {
