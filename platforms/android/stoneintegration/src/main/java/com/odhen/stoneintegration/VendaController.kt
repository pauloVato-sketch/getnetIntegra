...
import com.odhen.stoneintegration.pos.StoneIntegration
...
class VendaController(stoneCode: String, environment: String, context: Context) : com.odhen.deviceintagrationfacade.Controllers.VendaController, DeviceIntegrationListener, TransactionMessenger {
