...
class MSDEQuery {
    ...
    const QUERY_MAPPING = array(
        ...
        'SQL_DELETA_PRODUTOS_EST'                  => self::SQL_DELETA_PRODUTOS_EST,
        ...
        'SQL_DELETA_PROMOEST_ORIGINAL'             => self::SQL_DELETA_PROMOEST_ORIGINAL,
        'SQL_INSERE_ITEM_COMANDA'                  => self::SQL_INSERE_ITEM_COMANDA,
        'SQL_INSERE_ITEM_COMANDAEST'               => self::SQL_INSERE_ITEM_COMANDAEST,
        'SQL_DELETA_CMD_VEN_ORIG'                  => self::SQL_DELETA_CMD_VEN_ORIG,
        'SQL_DELETA_CMD_EST_ORIG'                  => self::SQL_DELETA_CMD_EST_ORIG,
        ...
        'SQL_INSERE_ITEMEST_ORIG'                  => self::SQL_INSERE_ITEMEST_ORIG,
        'GET_LOJAS_FILIAL'                         => self::GET_LOJAS_FILIAL,
        'GET_ALL_DELIVERY_ORDERS'                  => self::GET_ALL_DELIVERY_ORDERS,
        'GET_SALE_DELIVERY_PROPRIES'               => self::GET_SALE_DELIVERY_PROPRIES,
        'SQL_BUSCA_VOUCHER'                        => self::SQL_BUSCA_VOUCHER,
        'SQL_VOUCHER_DATA'                         => self::SQL_VOUCHER_DATA,
        'SQL_VALIDATE_VOUCHER'                     => self::SQL_VALIDATE_VOUCHER,
        'SQL_FILIAL_CUPOM'                         => self::SQL_FILIAL_CUPOM,
        'SQL_VOUCHER_USAGE'                        => self::SQL_VOUCHER_USAGE,
        'SQL_IDUTCUPOMDESC'                        => self::SQL_IDUTCUPOMDESC,
        'SQL_GET_VOUCHERED_PRODUCTS'               => self::SQL_GET_VOUCHERED_PRODUCTS,
        'SQL_GET_OBSERVATIONS_VEN'                 => self::SQL_GET_OBSERVATIONS_VEN,
        'SQL_DELETE_OBSITCOMANDAVEN'               => self::SQL_DELETE_OBSITCOMANDAVEN,
        'GET_COMANDAS_AGRUPAMENTO'                 => self::GET_COMANDAS_AGRUPAMENTO,
        'UPDATE_COMANDAVEN_AGRUPAMENTO'            => self::UPDATE_COMANDAVEN_AGRUPAMENTO,
        'GET_ITCOMANDAVEN_NRPRODCOMVEN'            => self::GET_ITCOMANDAVEN_NRPRODCOMVEN,
        'INSERT_ITCOMANDAVEN_AGRUPAMENTO'          => self::INSERT_ITCOMANDAVEN_AGRUPAMENTO,
        'INSERT_ITCOMANDAEST_AGRUPAMENTO'          => self::INSERT_ITCOMANDAEST_AGRUPAMENTO,
        'INSERT_OBSITCOMANDAVEN_AGRUPAMENTO'       => self::INSERT_OBSITCOMANDAVEN_AGRUPAMENTO,
        'INSERT_OBSITCOMANDAEST_AGRUPAMENTO'       => self::INSERT_OBSITCOMANDAEST_AGRUPAMENTO,
        'UPDATE_VRACRCOMANDA'                      => self::UPDATE_VRACRCOMANDA,
        'UPDATE_NRPESMESAVEN'                      => self::UPDATE_NRPESMESAVEN,
        'DEL_ITCOMANDAVEN_AGRUP'                   => self::DEL_ITCOMANDAVEN_AGRUP,
        'DEL_OBSITCOMANDAVEN_AGRUP'                => self::DEL_OBSITCOMANDAVEN_AGRUP,
        'DEL_ITCOMANDAEST_AGRUP'                   => self::DEL_ITCOMANDAEST_AGRUP,
        'DEL_OBSITCOMANDAEST_AGRUP'                => self::DEL_OBSITCOMANDAEST_AGRUP,
        'SELECT_BILLS_BY_GROUPING'                 => self::SELECT_BILLS_BY_GROUPING,
        'GET_RODIZIO'                              => self::GET_RODIZIO,
        'GET_RODIZIO_ITEMS'                        => self::GET_RODIZIO_ITEMS,
        'ATUALIZA_RODIZIO'                         => self::ATUALIZA_RODIZIO
    );
    ...
    const SQL_SELECIONA_ITEM = "
        ...
        FROM
          ...
          ITCOMANDAVEN IT LEFT JOIN ITMENUCONFTE IM
                ...
                AND IM.CDFILIAL = :FILIALVIGENCIA
    ...
    const SQL_INSERE_ITEM_POSICAO = "
       INSERT INTO
          ...
          CDLOJA, ?, ?, NRSEQPRODCUP, CDCAIXACOLETOR, VRPRECCLCOMVEN, CDPRODPROMOCAO, CDVENDEDOR, CDSENHAPED, DSOBSPEDDIGCMD,
    ...
    const SQL_DELETA_PRODUTOS_EST = "
        DELETE FROM ITCOMANDAEST
         WHERE CDFILIAL = ?
           AND NRVENDAREST = ?
           AND NRCOMANDA = ?
   ...
   ";
        ...
        SELECT B.CDFILIAL, B.NRMESA, B.NMMESA, B.CDSALA,
          ...
          FROM (SELECT MS.CDFILIAL, MS.NRMESA, MS.NMMESA, SL.CDSALA,
                 ...
                 WHERE MS.CDFILIAL     = :CDFILIAL
                   ...
                   AND IT.CDFILIAL = :FILIALVIGENCIA
    ...
    const SQL_DADOS_MESA_POS = "
        SELECT V.NRVENDAREST, V.NRPESMESAVEN, C.NRCOMANDA, V.CDVENDEDOR,
               ...
               M.NMMESA, M.NRMESA,  V.NRPOSICAOMESA, L.NMRAZSOCCLIE, V.DTHRABERMESA,
    ...
    const SQL_ITENS_DETALHADOS = "
        ...
        WHERE (IT.CDFILIAL = :CDFILIAL)
          ...
          AND (IT.NRVENDAREST = V.NRVENDAREST)
          AND (PR.IDPESAPROD = 'N')
          AND ((charindex(IT.NRLUGARMESA, :NRLUGARMESA) > 0)  or ('T' = :IMPPOSICAO))
          AND IT.CDPRODPROMOCAO IS NULL
    ...
    const SQL_DELETA_PROMOEST_ORIGINAL = "
        DELETE FROM ITCOMANDAEST
         WHERE CDFILIAL = ?
           AND NRVENDAREST  = ?
           AND NRCOMANDA    = ?
    ...
    const SQL_INSERE_ITEM_COMANDAEST = "
        INSERT INTO ITCOMANDAEST
          (CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO,
           QTPROCOMEST, VRPRECCOMEST, VRDESITCOMEST, TXPRODCOMVENEST, DSOBSPEDDIGEST)

        SELECT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO,
               QTPROCOMEST, VRPRECCOMEST, VRDESITCOMEST, TXPRODCOMVENEST, DSOBSPEDDIGEST
    ...
    const SQL_DELETA_CMD_EST_ORIG = "
      DELETE FROM ITCMDESTORIG
        WHERE CDFILIAL       = :CDFILIAL
          AND NRVENDAREST    = :NRVENDAREST
          AND NRCOMANDA      = :NRCOMANDA
          AND ((NRPRODCOMVEN = :NRPRODCOMVEN) OR (:NRPRODCOMVEN = 'T'))
    ...
    const SQL_PESQUISA_ITENS_COMANDA = "
        SELECT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN,
               ...
               IDPRODREFIL, QTITEMREFIL, IDDIVIDECONTA, CDCUPOMDESCFOS
          FROM ITCOMANDAVEN
         WHERE CDFILIAL    = ?
           AND NRVENDAREST = ?
           AND NRCOMANDA   = ?
    ...
    const SQL_DADOS_CAIXA = "
        SELECT CX.CDFILIAL, CX.CDCAIXA, CX.CDLOJA, CX.NRCONFTELA, CX.IDLEITURAQRCODE,
               ...
               CX.IDSENHACUP, CX.CDURLQRCODE, CX.IDTPCONTRREPIQ, CX.VRPEMAXREPIQVND,
               LJ.IDTRATTAXASERV, LJ.CDPRODTAXASERV
          FROM LOJA LJ,
    ...
    const SQL_FILIAL_DETAILS = "
        SELECT P.NRATRAPADRAO, P.IDUTLQTDPED, P.QTDMAXDIGNSU, P.IDSOLICITANSU,
               ...
               P.IDUTLSSL, P.IDEXTCONSONLINE, P.IDCTRLPEDVIAGEM, P.IDCONDESCTXSERV, P.HRTEMPOROD,
    ...
    const SQL_PRODUTOS_PARCIAL = "
        SELECT IT.NRVENDAREST, IT.NRCOMANDA, MIN(IT.NRPRODCOMVEN) AS NRPRODCOMVEN, SUM(IT.QTPRODCOMVEN) AS QTPRODCOMVEN,
               ...
               IT.CDPRODPROMOCAO, IT.NRSEQPRODCOM, IT.IDDESCMANUAL, IT.CDFILIAL, IT.NRORG, IT.DSOBSDESCIT, IT.CDGRPOCORDESCIT
          FROM ITCOMANDAVEN IT
    ...
    const SQL_VALIDA_PROD = "
        SELECT PR.CDARVPROD, PR.NMPRODUTO, PR.IDPESAPROD, PR.IDTIPOCOMPPROD,
               PR.IDIMPPRODUTO, PR.IDCONTROLAREFIL, PR.IDIMPRODUVEZ
          FROM PRODUTO PR
    ...
    const SQL_INS_ITCOMANDAVEN = "
        INSERT INTO ITCOMANDAVEN
			...
			IDORIGPEDCMD, DSOBSPEDDIGCMD, IDPRODREFIL, QTITEMREFIL,
            NRORG, CDCUPOMDESCFOS, CDCAMPCOMPGANHE, DTINIVGCAMPCG)
        VALUES
        	(:CDFILIAL, :NRVENDAREST, :NRCOMANDA, :NRPRODCOMVEN,
			:CDPRODUTO, :QTPRODCOMVEN, :VRPRECCOMVEN, :TXPRODCOMVEN,
			:IDSTPRCOMVEN, :VRDESCCOMVEN, :NRLUGARMESA, :DTHRINCOMVEN,
    ...
    const SQL_ITENS_DETALHADOS_SEM_COMBO = "
        ...
        WHERE (IT.CDFILIAL = :CDFILIAL)
          ...
          AND (IT.NRVENDAREST = V.NRVENDAREST)
          AND (PR.IDPESAPROD = 'N')
          AND ((charindex(NRLUGARMESA, :NRLUGARMESA) > 0) or ('T' = :IMPPOSICAO))
        ...
        SELECT
          ISNULL(IM.DSBUTTON, ISNULL(PR.NMPRODIMPFIS,PR.NMPRODUTO)) DSBUTTON, IT.CDFILIAL, IT.NRVENDAREST, IT.NRCOMANDA,
          IT.NRPRODCOMVEN AS NRPRODCOMVEN, IT.QTPRODCOMVEN AS QTPRODCOMVEN, IT.VRDESCCOMVEN AS VRDESCCOMVEN,
          IT.VRACRCOMVEN AS VRACRCOMVEN, IT.VRPRECCOMVEN AS VRPRECCOMVEN, PR.CDARVPROD, IT.CDPRODUTO, IT.IDSTPRCOMVEN,
          IT.NRMESADSCOMORIT, CONVERT(VARCHAR, IT.TXPRODCOMVEN) TXPRODCOMVEN, PR.IDCOBTXSERV,
          ISNULL(IT.NRLUGARMESA,'001') AS NRLUGARMESA, V.DTHRABERMESA, PR.CDBARPRODUTO AS CDPRODIMPFIS,
          IT.NRSEQPRODCOM, IT.NRSEQPRODCUP, IT.CDPRODPROMOCAO, GROUPS.DSBUTTON AS GRUPO,
    ...
    const SQL_ITENS_ORIGINAIS = "
        SELECT
          ...
          MIN(IT.NRPRODCOMVEN) AS NRPRODCOMVEN, SUM(IT.QTPRODCOMVEN) AS QTPRODCOMVEN, IT.VRDESCCOMVEN AS VRDESCCOMVEN,
          IT.VRACRCOMVEN AS VRACRCOMVEN, IT.VRPRECCOMVEN AS VRPRECCOMVEN, PR.CDARVPROD, IT.CDPRODUTO, IT.IDSTPRCOMVEN,
          CONVERT(VARCHAR, IT.TXPRODCOMVEN) TXPRODCOMVEN, PR.IDCOBTXSERV, IT.VRPRECCLCOMVEN,
          ISNULL(IT.NRLUGARMESA,'001') AS NRLUGARMESA, V.DTHRABERMESA, PR.CDBARPRODUTO AS CDPRODIMPFIS,
          IT.NRSEQPRODCOM, IT.NRSEQPRODCUP, IT.CDPRODPROMOCAO, GROUPS.DSBUTTON AS GRUPO,
          CONVERT(CHAR,IT.DTHRINCOMVEN,103) AS DATA, CONVERT(CHAR,IT.DTHRINCOMVEN,108) AS HORA
        FROM
        ...
        GROUP BY
          IM.DSBUTTON, IT.CDFILIAL, IT.NRVENDAREST, IT.NRCOMANDA, ISNULL(PR.NMPRODIMPFIS,PR.NMPRODUTO),
          IT.VRDESCCOMVEN, IT.VRACRCOMVEN, IT.VRPRECCOMVEN, PR.CDARVPROD, IT.CDPRODUTO, IT.IDSTPRCOMVEN,
          PR.IDCOBTXSERV, IT.VRPRECCLCOMVEN, IT.NRLUGARMESA , V.DTHRABERMESA, CONVERT(VARCHAR, IT.TXPRODCOMVEN),
          PR.CDBARPRODUTO, IT.NRPRODCOMVEN, IT.QTPRODCOMVEN, IT.VRDESCCOMVEN, IT.VRACRCOMVEN, IT. NRSEQPRODCOM,
          IT.NRSEQPRODCUP, IT.CDPRODPROMOCAO, IM.NRBUTTON, GROUPS.DSBUTTON, CONVERT(CHAR,IT.DTHRINCOMVEN,103),
          CONVERT(CHAR,IT.DTHRINCOMVEN,108)
    ...
    const SQL_DADOS_ITEM_COMANDA = "
      ...
      DISTINCT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN,
               ...
               VRACRCOMVEN, DSCOMANDAORI, NRCOMANDAORI, NRPRODCOMORI,
               CDCAIXACOLETOR, VRPRECCLCOMVEN, NRMESADSCOMORIT, CDVENDEDOR,
               CDPRODPROMOCAO, NRPEDIDOFOS, CDSENHAPED, NRATRAPRODCOVE,
               IDORIGPEDCMD, CDCUPOMDESCFOS,
    ...
    const SQL_DADOS_COMANDA = "
        SELECT C.DSCOMANDA, C.NRVENDAREST, C.NRCOMANDA, C.IDSTCOMANDA,
               V.CDLOJA, V.NRMESA, C.VRDESCOMANDA, C.VRCOMISVENDE, V.DTHRABERMESA,
    ...
    const SQL_DADOS_COMANDA_ABERTURA = "
        SELECT C.DSCOMANDA, C.NRVENDAREST, C.NRCOMANDA, C.IDSTCOMANDA,
               ...
               ISNULL(ISNULL(C.DSCONSUMIDOR, CO.NMCONSUMIDOR), '') AS LABELDSCOMANDA, C.IDSTCOMANDA, C.DSCOMANDAPRI
          FROM COMANDAVEN C JOIN VENDAREST V
                              ON C.CDFILIAL    = V.CDFILIAL
                             AND C.NRVENDAREST = V.NRVENDAREST
                             AND C.CDLOJA      = V.CDLOJA
    ...
    const SQL_INSERE_ITEMEST_ORIG = "
        INSERT INTO ITCMDESTORIG(
            CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO,
            QTPROCOMEST, VRPRECCOMEST, VRDESITCOMEST, TXPRODCOMVENEST, DSOBSPEDDIGEST
        )
        SELECT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO,
    ...
    const GET_LOJAS_FILIAL = "
        SELECT CDLOJA, NMLOJA
        FROM LOJA
        WHERE CDFILIAL = :CDFILIAL
    ";

    const GET_ALL_DELIVERY_ORDERS = "
        SELECT DISTINCT P.CDFILIAL, P.CDLOJA,
                IDSTCOMANDA, P.NRVENDAREST, DTHRABERMESA, CDCONSUMIDOR, NMCONSUMIDOR,
                NRTELECONS, P.NRCOMANDA, SUBSTRING(DSCOMANDA, 5, 100) DSCOMANDA, CDCLIENTE, NRCPFRESPCON,
                CDMUNICIPIO, CDPAIS, SGESTADO, CDBAIRRO, DSBAIRRO, DSENDECONSCOMAN,
    ...
    const GET_SALE_DELIVERY_PROPRIES = "
         SELECT VE.NRSEQVENDA,
               (CONVERT(varchar, VE.DTSAIDAVENDA, 3)+' '+ CONVERT(varchar, VE.DTSAIDAVENDA, 8)) DTSAIDAVENDA,
               (CONVERT(varchar, VE.DTCHEGAVENDA, 3)+' '+ CONVERT(varchar, VE.DTCHEGAVENDA, 8)) DTCHEGAVENDA, VD.NRINSJURVEN, VD.NMFANVEN, MU.NMMUNICIPIO,
               RG.CDREGIAOMUNI, RG.NMREGIAOMUNI, VE.DSENDECONSVENDA,
               BA.CDBAIRRO, ISNULL(BA.NMBAIRRO, VE.DSBAIRRO) AS NMBAIRRO, PA.NMPAIS,
               ES.NMESTADO, VE.NRCOMANDAVND, VE.DSCOMPLENDCOVEN,
               CONVERT(CHAR,VE.DTVENDA,8) AS DTVENDA, CAST(VE.DSREFENDCONSVEN AS VARCHAR(2000)) AS DSREFENDCONSVEN,
               VE.NRNOTAFISCALCE, VD.CDVENDEDOR
            FROM
               VENDA VE LEFT JOIN VENDEDOR VD ON (VE.CDVENDEDOR = VD.CDVENDEDOR),
               CONSUMIDOR CD, PAIS PA, ESTADO ES, MUNICIPIO MU,
               BAIRRO BA LEFT JOIN REGIAOMUNI RG ON (BA.CDPAIS        = RG.CDPAIS)
    ...
    const SQL_BUSCA_VOUCHER = "
        SELECT CDCUPOMDESCFOS
          FROM PRODCUPOMDESC
         WHERE CDPRODUTO = :CDPRODUTO
           AND CDCUPOMDESCFOS = :CDCUPOMDESCFOS
    ";

    const SQL_VOUCHER_DATA = "
    ...
    const SQL_VALIDATE_VOUCHER = "
        SELECT CDCUPOMDESCFOS, DSCUPOMDESCFOS, IDTIPODESC, VRDESCCUPOM,
               DTINIVIGENCIA, DTFIMVIGENCIA, IDUSOUNICO
          FROM CUPOMDESCFOS
         WHERE CDCUPOMDESCFOS = :CDCUPOMDESCFOS
           AND CAST(GETDATE() AS DATE) BETWEEN CAST(DTINIVIGENCIA AS DATE) AND CAST(DTFIMVIGENCIA AS DATE)
    ";

    const SQL_FILIAL_CUPOM = "
        SELECT CDFILIAL
          FROM FILIALCUPOMDESC
         WHERE CDCUPOMDESCFOS = :CDCUPOMDESCFOS
    ";

    const SQL_VOUCHER_USAGE = "
        SELECT CDCUPOMDESCFOS
          FROM USOCUPOMDESCFOS
         WHERE CDCUPOMDESCFOS = :CDCUPOMDESCFOS
    ";

    const SQL_IDUTCUPOMDESC = "
        SELECT IDUTCUPOMDESC
          FROM PARAMGERAL
    ";

    const SQL_GET_VOUCHERED_PRODUCTS = "
        SELECT NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO, CDCUPOMDESCFOS
          FROM ITCOMANDAVEN
         WHERE CDFILIAL = :CDFILIAL
           AND NRVENDAREST = :NRVENDAREST
           AND NRCOMANDA = :NRCOMANDA
    ...
    const SQL_GET_OBSERVATIONS_VEN = "
        SELECT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN,
            CDGRPOCOR, CDOCORR, NRORG, IDATIVO, QTPRODCOMVENOBS
    ...
    const SQL_DELETE_OBSITCOMANDAVEN = "
        DELETE OBSITCOMANDAVEN
         WHERE NRVENDAREST = :NRVENDAREST
           AND NRCOMANDA = :NRCOMANDA
           AND NRPRODCOMVEN = :NRPRODCOMVEN
    ";
    ...
    const GET_COMANDAS_AGRUPAMENTO = "
        SELECT C.DSCOMANDA, C.NRVENDAREST, C.NRCOMANDA, C.DSCOMANDA + (CASE WHEN ISNULL(C.DSCONSUMIDOR, CO.NMCONSUMIDOR) IS NULL THEN '' ELSE ' - ' END) + ISNULL(ISNULL(C.DSCONSUMIDOR, CO.NMCONSUMIDOR), '') AS LABELDSCOMANDA, C.DSCOMANDAPRI
           FROM COMANDAVEN C JOIN VENDAREST V
                 ON C.CDFILIAL = V.CDFILIAL
                 AND C.CDLOJA = V.CDLOJA
                AND C.NRVENDAREST = V.NRVENDAREST
    ...
    const INSERT_ITCOMANDAVEN_AGRUPAMENTO = "
        INSERT INTO ITCOMANDAVEN
          (CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO, QTPRODCOMVEN, VRPRECCOMVEN, TXPRODCOMVEN, IDSTPRCOMVEN,
          VRDESCCOMVEN, NRLUGARMESA, DTHRINCOMVEN, IDPRODIMPFIS, CDLOJA, VRACRCOMVEN, NRSEQPRODCOM, NRSEQPRODCUP, CDCAIXACOLETOR,
          VRPRECCLCOMVEN, CDPRODPROMOCAO, CDVENDEDOR, CDSENHAPED, DSOBSPEDDIGCMD, IDORIGPEDCMD, IDDIVIDECONTA, NRPRODORIG, IDPRODREFIL, QTITEMREFIL, NRPEDIDOFOS, DSCOMANDAORI, NRCOMANDAORI, NRPRODCOMORI)
        SELECT CDFILIAL, :MBNRVENDAREST, :MBNRCOMANDA, :MAXNRPRODCOMVEN, CDPRODUTO, QTPRODCOMVEN, VRPRECCOMVEN, TXPRODCOMVEN, IDSTPRCOMVEN, VRDESCCOMVEN, NRLUGARMESA, DTHRINCOMVEN, IDPRODIMPFIS, CDLOJA, VRACRCOMVEN, NRSEQPRODCOM, NRSEQPRODCUP, CDCAIXACOLETOR, VRPRECCLCOMVEN, CDPRODPROMOCAO, CDVENDEDOR, CDSENHAPED, DSOBSPEDDIGCMD, IDORIGPEDCMD, IDDIVIDECONTA, NRPRODORIG, IDPRODREFIL, QTITEMREFIL, NRPEDIDOFOS, :DSCOMANDAORI, :NRCOMANDAORI, :NRPRODCOMORI
         FROM ITCOMANDAVEN
        WHERE CDFILIAL     = :CDFILIAL
          AND NRVENDAREST  = :NRVENDAREST
          AND NRCOMANDA    = :NRCOMANDA
    ...
    const INSERT_ITCOMANDAEST_AGRUPAMENTO = "
        INSERT INTO ITCOMANDAEST
          (CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDPRODUTO,
          QTPROCOMEST, VRPRECCOMEST, VRDESITCOMEST, TXPRODCOMVENEST, DSOBSPEDDIGEST)
        SELECT CDFILIAL, :MBNRVENDAREST, :MBNRCOMANDA, :MAXNRPRODCOMVEN, CDPRODUTO,
          QTPROCOMEST, VRPRECCOMEST, VRDESITCOMEST, TXPRODCOMVENEST, DSOBSPEDDIGEST
         FROM ITCOMANDAEST
        WHERE CDFILIAL       = :CDFILIAL
          AND NRVENDAREST    = :NRVENDAREST
    ...
    const INSERT_OBSITCOMANDAVEN_AGRUPAMENTO = "
        INSERT INTO  OBSITCOMANDAVEN
          (CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN, CDOCORR,
           CDGRPOCOR, NRPRODCOMVENOBS, QTPRODCOMVENOBS)
        SELECT CDFILIAL, :MBNRVENDAREST, :MBNRCOMANDA, :MAXNRPRODCOMVEN, CDOCORR,
          CDGRPOCOR, NRPRODCOMVENOBS, QTPRODCOMVENOBS
          FROM OBSITCOMANDAVEN
         WHERE CDFILIAL       = :CDFILIAL
          AND NRVENDAREST    = :NRVENDAREST
    ...
    const INSERT_OBSITCOMANDAEST_AGRUPAMENTO = "
        INSERT INTO OBSITCOMANDAEST
          (CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN,
          CDPRODUTO, CDGRPOCOR, CDOCORR)
        SELECT CDFILIAL, :MBNRVENDAREST, :MBNRCOMANDA, :MAXNRPRODCOMVEN,
          CDPRODUTO, CDGRPOCOR, CDOCORR
         FROM OBSITCOMANDAEST
        WHERE CDFILIAL       = :CDFILIAL
          AND NRVENDAREST    = :NRVENDAREST
    ...
    const UPDATE_VRACRCOMANDA = "
        UPDATE COMANDAVEN
           SET VRACRCOMANDA = VRACRCOMANDA + :ACRCOMANDA
         WHERE CDFILIAL    = :CDFILIAL
           AND NRCOMANDA   = :NRCOMANDA
           AND NRVENDAREST = :NRVENDAREST
    ";

    const UPDATE_NRPESMESAVEN = "
        UPDATE VENDAREST
           SET NRPESMESAVEN = NRPESMESAVEN + :NRPESMESAVEN
         WHERE CDFILIAL    = :CDFILIAL
           AND CDLOJA      = :CDLOJA
           AND NRVENDAREST = :NRVENDAREST
    ";
    ...
    const SELECT_BILLS_BY_GROUPING = "
        SELECT DSCOMANDA, NRVENDAREST, NRCOMANDA, DSCOMANDAPRI
          FROM COMANDAVEN
         WHERE CDFILIAL     = :CDFILIAL
           AND CDLOJA       = :CDLOJA
           AND DSCOMANDAPRI = :DSCOMANDA
           AND IDSTCOMANDA  = '4'
           AND (SUBSTRING(DSCOMANDA,1,4) <> 'RES_')
           AND (SUBSTRING(DSCOMANDA,1,4) <> 'PKR_')
           AND (SUBSTRING(DSCOMANDA,1,4) <> 'DLV_')
    ";

    const UPDATE_COMANDAVEN_AGRUPAMENTO = "
        UPDATE COMANDAVEN
           SET DSCOMANDAPRI = :DSCOMANDAPRI, IDSTCOMANDA = :IDSTCOMANDA
         WHERE CDFILIAL     = :CDFILIAL
           AND CDLOJA       = :CDLOJA
           AND NRVENDAREST  = :NRVENDAREST
           AND NRCOMANDA    = :NRCOMANDA
    ...
    const GET_ITCOMANDAVEN_NRPRODCOMVEN = "
        SELECT NRPRODCOMVEN
         FROM ITCOMANDAVEN
        WHERE CDFILIAL    = :CDFILIAL
          AND NRVENDAREST = :NRVENDAREST
    ...
    const DEL_ITCOMANDAVEN_AGRUP = "
        DELETE FROM ITCOMANDAVEN
         WHERE CDFILIAL     = :CDFILIAL
           AND NRVENDAREST  = :NRVENDAREST
           AND NRCOMANDA    = :NRCOMANDA
           AND DSCOMANDAORI = :DSCOMANDAORI
           AND NRCOMANDAORI = :NRCOMANDAORI
           AND NRPRODCOMORI IN (:NRPRODCOMORI)
    ";

    const DEL_OBSITCOMANDAVEN_AGRUP = "
        DELETE
          FROM OBSITCOMANDAVEN
         WHERE CDFILIAL     = :CDFILIAL
           AND NRVENDAREST  = :NRVENDAREST
    ...
    const DEL_OBSITCOMANDAEST_AGRUP = "
        DELETE
          FROM OBSITCOMANDAEST
         WHERE CDFILIAL     = :CDFILIAL
           AND NRVENDAREST  = :NRVENDAREST
    ...
    const GET_RODIZIO = "
        SELECT CDFILIAL, NRVENDAREST, NRCOMANDA, NRPRODCOMVEN,
               CDPRODUTO, NRLUGARMESA, IDSTPRCOMVEN, DTHRINCOMVEN
          FROM ITCOMANDAVEN
         WHERE CDFILIAL = :CDFILIAL
           AND NRVENDAREST = :NRVENDAREST
           AND NRCOMANDA = :NRCOMANDA
           AND CDPRODUTO = :CDPRODUTO
           AND (IDSTPRCOMVEN <> '6' AND IDSTPRCOMVEN <> '7')
         ORDER BY DTHRINCOMVEN
    ";

    const GET_RODIZIO_ITEMS = "
        SELECT QTPROCOMEST
          FROM ITCOMANDAEST
         WHERE CDFILIAL = :CDFILIAL
           AND NRVENDAREST = :NRVENDAREST
    ...
    const ATUALIZA_RODIZIO = "
        UPDATE ITCOMANDAEST
           SET QTPROCOMEST = :QTPROCOMEST
         WHERE CDFILIAL = :CDFILIAL
           AND NRVENDAREST = :NRVENDAREST
           AND NRCOMANDA = :NRCOMANDA
           AND NRPRODCOMVEN = :NRPRODCOMVEN
