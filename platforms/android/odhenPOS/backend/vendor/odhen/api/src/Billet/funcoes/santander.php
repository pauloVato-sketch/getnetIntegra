...
$nummoeda = "9";
$fixo     = "9";   // Numero fixo para a posiï¿½ï¿½o 05-05
...
//$barra = "$codigobanco$nummoeda$fator_vencimento$valor$codigocliente$nossonumero$ios$carteira";
//$barra = "$codigobanco$nummoeda$fixo$codigocliente$nossonumero$ios$carteira$fator_vencimento$valor";
...
//Guarda inicial
?><img src="images/billet/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="images/billet/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="images/billet/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="images/billet/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src="images/billet/p.png" width=<?php echo $f1?> height=<?php echo $altura?> border=0><img
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src="images/billet/b.png" width=<?php echo $f2?> height=<?php echo $altura?> border=0><img
<?php
  }
}
...
// Draw guarda final
?>
src="images/billet/p.png" width=<?php echo $largo?> height=<?php echo $altura?> border=0><img
src="images/billet/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="images/billet/p.png" width=<?php echo 1?> height=<?php echo $altura?> border=0>
  <?php
} //Fim da funï¿½ï¿½o
...
function modulo_11_invertido($num)  // Calculo de Modulo 11 "Invertido" (com pesos de 9 a 2  e nï¿½o de 2 a 9)
{
   $ftini = 2;
   $fator = $ftfim = 9;
   $soma = 0;
...
function monta_linha_digitavel($codigo)
{
  ...
  // 4        Cï¿½digo da Moeda - 9 para Real ou 8 - outras moedas
  // 5        Fixo "9'
  ...
  // 30 a 30  Dï¿½gito verificador do cï¿½digo de barras
  // 31 a 34  Fator de vencimento (qtdade de dias desde 07/10/1997 atï¿½ a data de vencimento)
  // 35 a 44  Valor do tï¿½tulo

  // 1. Primeiro Grupo - composto pelo cï¿½digo do banco, cï¿½digo da moï¿½da, Valor Fixo "9"
  ...
  // 2. Segundo Grupo - composto pelas 3 ï¿½ltimas posiï¿½oes do PSK e 7 primeiros dï¿½gitos do Nosso Nï¿½mero
