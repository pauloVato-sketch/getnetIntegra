...
use Zeedhi\Framework\Session\Attribute\NamespacedAttribute;

class NamespacedAttributeTest extends \PHPUnit\Framework\TestCase {
	...
	protected function setUp() {
		...
		$this->bag = new NamespacedAttribute('zeedhiAttribute', '/');
	...
	public function testGetStorageKey() {
		...
		$attributeBag = new NamespacedAttribute('test');
