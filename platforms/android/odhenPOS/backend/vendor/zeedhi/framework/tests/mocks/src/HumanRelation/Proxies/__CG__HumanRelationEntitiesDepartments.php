 ...
 */
class Departments extends \HumanRelation\Entities\Departments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'departmentId', 'departmentName', 'managerId', 'location', 'description');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Departments $proxy) {
