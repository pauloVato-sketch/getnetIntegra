...
class Response {
	 ...
	 * @param string $contentType An array of response headers
	 * @param int    $statusCode  The response status code
	 * @param array  $headers     An array of response headers
	 *
	 */
	public function __construct($content = '', $contentType = '', $statusCode = 200, $headers = array()) {
	...
	/**
	 * Returns headers send to response
	 *
	 * @return Header
	 */
